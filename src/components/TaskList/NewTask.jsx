...
const NewTask = ({data}) => {
  return (
    <div className='flex-shrink-0 h-full w-[300px] bg-[#335beb] p-5 rounded-xl overflow-auto task-list'>
        ...
        <div className='flex justify-between items-center mt-4'>
            <button className='bg-emerald-600 text-white px-4 py-2 rounded-lg mt-4 hover:bg-emerald-700 active:bg-emerald-00 cursor-pointer'>
                Accept Task
            </button>
        </div>
      </div>
