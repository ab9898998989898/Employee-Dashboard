...
const FailedTask = ({data}) => {
  return (
    <div className='flex-shrink-0 h-full w-[300px] bg-[#f55252] p-5 rounded-xl overflow-auto task-list'>
        ...
        <div className='flex justify-between items-center mt-4'>
            <button className='bg-red-600 text-white px-4 py-2 rounded-lg mt-4 hover:bg-red-700 active:bg-red-800 cursor-pointer'>Failed</button>
        </div>
      </div>
  )
}
